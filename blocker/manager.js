...
function renderStorageStatus() {
  ...
  if (state.storageStatus?.syncPending) {
    elements.syncLabel.textContent = 'Saved locally — Firefox mirror pending';
    elements.syncLabel.title = state.storageStatus.syncError || 'Firefox will retry its local profile mirror.';
  } else {
