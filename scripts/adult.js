(function () {
    ...
    const blockedStringKeywords = [
    	"deepnude", "nudify", "undress", "alexa_poshspisy", "Alexa_poshspisy", "alexa", "alexaposhspicy-model", "alexaposhspicy", "whore", "slut", "dreamtime AI", "face swap", 
    ...
    // List of blocked keywords or phrases in video titles, usernames, and channel names (regex-based)
    const blockedRegexKeywords = [
    	/deepn/i, /deepf/i, /deeps/i, /udif/i, /nudif/i, /alexa/i, /ndres/i, /poshspisy/i, /alexa_poshspisy/i, /Liv Morgan/i, /Liv Xoxo/i, /Morgan Xoxo/i, /Sweeney/i, /Sydne/i, /Kristen Stewart/i, /Steward/i, /facemorph/i, /face morph/i, /morphface/i, /morph face/i, /LGBT/i,
    ...
    function checkAndRedirectVideoPageBlockedContent() {
        ...
        elements.forEach(element => {
            if (blockedStringKeywords.some(keyword => element.innerText.toLowerCase().includes(keyword.toLowerCase())) ||
                blockedRegexKeywords.some(keyword => keyword.test(element.innerText))) {
    ...
    function checkAndRedirectUrlBlockedContent() {
        ...
        if (searchTerm && (blockedStringKeywords.some(keyword => searchTerm.toLowerCase().includes(keyword.toLowerCase())) ||
            blockedRegexKeywords.some(keyword => keyword.test(searchTerm)))) {
